...
public interface AppMoreRecommendPresent extends BasePresenter<AppMoreRecommendActivityView> {

    void getAppMoreRecommendDate(BaseActivity activity, String type, String packageName);
}
